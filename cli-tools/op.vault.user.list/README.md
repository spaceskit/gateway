# 1Password Vault User List

## Purpose
List users with access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.vault.user.list`
- Wrapper operation: `vault.user.list`
- 1Password CLI mapping: `op vault user list <vault>`
