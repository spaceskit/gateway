# 1Password Vault User Revoke

## Purpose
Revoke a user's access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.vault.user.revoke`
- Wrapper operation: `vault.user.revoke`
- 1Password CLI mapping: `op vault user revoke <vault> <user>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: vault, user.
