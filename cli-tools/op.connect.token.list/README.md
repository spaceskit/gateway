# 1Password Connect Token List

## Purpose
List 1Password Connect tokens.

## Wrapper Operation
- Tool id: `op.connect.token.list`
- Wrapper operation: `connect.token.list`
- 1Password CLI mapping: `op connect token list`
