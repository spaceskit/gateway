# 1Password User Recovery Begin

## Purpose
Begin user recovery for one or more 1Password users.

## Wrapper Operation
- Tool id: `op.user.recovery.begin`
- Wrapper operation: `user.recovery.begin`
- 1Password CLI mapping: `op user recovery begin <user> [additional-users]`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: user, additional-users.
