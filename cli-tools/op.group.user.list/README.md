# 1Password Group User List

## Purpose
List users in a 1Password group.

## Wrapper Operation
- Tool id: `op.group.user.list`
- Wrapper operation: `group.user.list`
- 1Password CLI mapping: `op group user list <group>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: group.
