# 1Password Service Account Create

## Purpose
Create a 1Password service account.

## Wrapper Operation
- Tool id: `op.service_account.create`
- Wrapper operation: `service_account.create`
- 1Password CLI mapping: `op service-account create`
