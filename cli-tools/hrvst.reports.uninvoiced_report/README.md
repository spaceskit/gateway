# Harvest Uninvoiced Report

## Purpose
Return the Harvest uninvoiced report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.uninvoiced_report`
- Wrapper operation: `reports.uninvoiced_report`
- Harvest CLI mapping: `hrvst reports uninvoiced-report`
