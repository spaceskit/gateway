# 1Password Item Share

## Purpose
Create or manage a share link for a 1Password item.

## Wrapper Operation
- Tool id: `op.item.share`
- Wrapper operation: `item.share`
- 1Password CLI mapping: `op item share <item>`
