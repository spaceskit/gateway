# Harvest Project Budget Report

## Purpose
Return the Harvest project budget report.

## Wrapper Operation
- Tool id: `hrvst.reports.project_budget_report`
- Wrapper operation: `reports.project_budget_report`
- Harvest CLI mapping: `hrvst reports project-budget-report`
