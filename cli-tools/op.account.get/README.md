# 1Password Account Get

## Purpose
Get details about one configured 1Password account.

## Wrapper Operation
- Tool id: `op.account.get`
- Wrapper operation: `account.get`
- 1Password CLI mapping: `op account get <account>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: account.
