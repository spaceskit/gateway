# 1Password Events API Create

## Purpose
Create a 1Password Events API integration token.

## Wrapper Operation
- Tool id: `op.events_api.create`
- Wrapper operation: `events_api.create`
- 1Password CLI mapping: `op events-api create`
