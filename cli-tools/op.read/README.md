# 1Password Read Secret

## Purpose
Read a secret or field value from 1Password using a secret reference.

## Wrapper Operation
- Tool id: `op.read`
- Wrapper operation: `read`
- 1Password CLI mapping: `op read <secret-reference>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: secret-reference.
