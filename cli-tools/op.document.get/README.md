# 1Password Document Get

## Purpose
Get a 1Password document or write it to a file via flags.

## Wrapper Operation
- Tool id: `op.document.get`
- Wrapper operation: `document.get`
- 1Password CLI mapping: `op document get <document>`
