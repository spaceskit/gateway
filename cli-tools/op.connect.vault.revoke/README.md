# 1Password Connect Vault Revoke

## Purpose
Revoke a Connect server's access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.connect.vault.revoke`
- Wrapper operation: `connect.vault.revoke`
- 1Password CLI mapping: `op connect vault revoke <server> <vault>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: server, vault.
