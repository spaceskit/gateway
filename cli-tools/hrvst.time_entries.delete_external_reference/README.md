# Harvest Time Entry Delete External Reference

## Purpose
Delete the external reference on a Harvest time entry.

## Wrapper Operation
- Tool id: `hrvst.time_entries.delete_external_reference`
- Wrapper operation: `time_entries.delete_external_reference`
- Harvest CLI mapping: `hrvst time-entries delete-external-reference`
