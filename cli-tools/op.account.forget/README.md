# 1Password Account Forget

## Purpose
Forget a 1Password account on this device.

## Wrapper Operation
- Tool id: `op.account.forget`
- Wrapper operation: `account.forget`
- 1Password CLI mapping: `op account forget`
