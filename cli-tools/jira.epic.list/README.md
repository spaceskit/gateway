...
## Purpose
List Jira epics, or list issues inside one epic, with compact summary rows by default and raw Jira JSON optionally.

## Wrapper Operation
- Tool id: `jira.epic.list`
- Wrapper operation: `epic.list`
- Jira CLI mapping: `jira epic list`
...
- `epicKey` (optional): Optional Jira epic key.
