# Harvest Projects Expense Report

## Purpose
Return the Harvest projects expense report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.expense.projects`
- Wrapper operation: `reports.expense.projects`
- Harvest CLI mapping: `hrvst reports expense-reports projects-expense-report`
