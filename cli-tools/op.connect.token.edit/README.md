# 1Password Connect Token Edit

## Purpose
Rename a 1Password Connect server token.

## Wrapper Operation
- Tool id: `op.connect.token.edit`
- Wrapper operation: `connect.token.edit`
- 1Password CLI mapping: `op connect token edit <token>`
