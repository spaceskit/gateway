# 1Password Group User Grant

## Purpose
Add a user to a 1Password group.

## Wrapper Operation
- Tool id: `op.group.user.grant`
- Wrapper operation: `group.user.grant`
- 1Password CLI mapping: `op group user grant <group> <user>`
