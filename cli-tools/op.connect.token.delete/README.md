# 1Password Connect Token Delete

## Purpose
Delete a 1Password Connect server token.

## Wrapper Operation
- Tool id: `op.connect.token.delete`
- Wrapper operation: `connect.token.delete`
- 1Password CLI mapping: `op connect token delete <token>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: token.
