# 1Password Connect Server Get

## Purpose
Get one 1Password Connect server.

## Wrapper Operation
- Tool id: `op.connect.server.get`
- Wrapper operation: `connect.server.get`
- 1Password CLI mapping: `op connect server get <server>`
