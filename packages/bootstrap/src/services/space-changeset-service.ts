...
function mapChangeSet(row: SpaceChangeSetRow): ChangeSet {
  return {
...
function mapChangeSetFile(row: SpaceChangeSetFileRow): ChangeSetFile {
  return {
...
function mapChangeSetReview(row: SpaceChangeSetReviewRow): ChangeSetReview {
  return {
...
function normalizeParticipantMode(value: string): "read_only" | "collaborator" {
...
function resolveModeratorPrincipalIds(config: Record<string, unknown>): string[] {
