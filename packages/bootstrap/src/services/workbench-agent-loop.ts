...
function buildPlanningPrompt(
  ...
  return [
    ...
    "The Workbench is an opt-in legacy runner. Execute only the supplied queue item through the Spaces-native Workbench protocol.",
    "",
...
function buildImplementationPrompt(
  ...
  return [
    ...
    "The Workbench owns status write-back (in-progress/review/blocked — never done/dropped). Do not invoke external task-store binaries.",
    "",
