...
function buildPlanningPrompt(
  ...
  return [
    ...
    "Treat external harnesses as reference material or future executor adapters only; this run must stay inside the Spaces-native Workbench protocol.",
    "",
...
function buildImplementationPrompt(
  ...
  return [
    ...
    "If another harness or CLI would be useful, mention it as a future executor adapter candidate instead of adding it as a dependency during this run.",
    "",
