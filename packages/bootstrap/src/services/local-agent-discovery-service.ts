...
export const LOCAL_CLIENT_TEMPLATES: LocalClientTemplate[] = [
  ...
  },
  {
    ...
    recommendedModel: "codex/gpt-5.5",
    requiresApiKey: false,
  ...
  },
  {
    ...
    recommendedProviderId: "antigravity",
    recommendedModel: "antigravity/selected",
    requiresApiKey: false,
    defaultProfileName: "Antigravity Agent",
    defaultPersonalityPrompt: "You are an Antigravity-backed agent focused on implementation and grounded workspace reasoning.",
    notes: "Uses the model currently selected in Antigravity CLI via /model.",
  },
  {
    id: "codex-app-server",
    ...
    recommendedModel: "codex-app-server/gpt-5.5",
    requiresApiKey: false,
