...
export const MessageTypes = {
  ...
  SPACE_OPEN_WORKSPACE: "space.open_workspace",
  ...
  GATEWAY_GET_RUNTIME_DEFAULTS: "gateway.get_runtime_defaults",
  GATEWAY_SET_RUNTIME_DEFAULTS: "gateway.set_runtime_defaults",
  ...
  SCHEDULER_LIST_EVAL_DEFINITIONS: "scheduler.list_eval_definitions",
  ...
  WORKBENCH_LIST_QUEUE: "workbench.list_queue",
  WORKBENCH_GET_QUEUE_ITEM: "workbench.get_queue_item",
  WORKBENCH_CREATE_BATCH: "workbench.create_batch",
  WORKBENCH_LIST_BATCHES: "workbench.list_batches",
  WORKBENCH_UPDATE_BATCH: "workbench.update_batch",
  WORKBENCH_START_RUN: "workbench.start_run",
  WORKBENCH_RETRY_RUN: "workbench.retry_run",
  WORKBENCH_CANCEL_RUN: "workbench.cancel_run",
  WORKBENCH_LIST_RUNS: "workbench.list_runs",
  WORKBENCH_GET_RUN: "workbench.get_run",
  WORKBENCH_APPROVE_STAGE: "workbench.approve_stage",
  WORKBENCH_REJECT_STAGE: "workbench.reject_stage",
  WORKBENCH_SET_MODE: "workbench.set_mode",
  WORKBENCH_LIST_ARTIFACTS: "workbench.list_artifacts",
  WORKBENCH_GET_POLICY: "workbench.get_policy",
  WORKBENCH_UPDATE_POLICY: "workbench.update_policy",
  WORKBENCH_LIST_SCENARIOS: "workbench.list_scenarios",
  WORKBENCH_START_SCENARIO_RUN: "workbench.start_scenario_run",
  WORKBENCH_LIST_SCENARIO_RUNS: "workbench.list_scenario_runs",
  WORKBENCH_GET_SCENARIO_RUN: "workbench.get_scenario_run",
  WORKBENCH_CANCEL_SCENARIO_RUN: "workbench.cancel_scenario_run",
  AGENT_PRESENCE_LIST: "agent_presence.list",
  AGENT_PRESENCE_SUBSCRIBE: "agent_presence.subscribe",
  AGENT_PRESENCE_ANSWER: "agent_presence.answer",
  ...
  AGENT_PRESENCE_UPDATED: "agent_presence.updated",
