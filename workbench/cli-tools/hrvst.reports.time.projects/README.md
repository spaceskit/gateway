...
## Purpose
Return the Harvest projects time report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.time.projects`
- Wrapper operation: `reports.time.projects`
- Harvest CLI mapping: `hrvst reports time-reports projects-time-report`
