# Peekaboo App Relaunch

## Purpose
Relaunch an application through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.app.relaunch`
- Wrapper operation: `app.relaunch`
- Peekaboo CLI mapping: `peekaboo app relaunch`
