...
## Purpose
Capture the current macOS UI, extract accessibility metadata, and optionally save annotated screenshots.

## Wrapper Operation
- Tool id: `peekaboo.see`
- Wrapper operation: `see`
- Peekaboo CLI mapping: `peekaboo see`
