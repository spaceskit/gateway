...
## Purpose
Inspect Screen Recording, Accessibility, and event-synthesizing permissions for Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.permissions.status`
- Wrapper operation: `permissions.status`
- Peekaboo CLI mapping: `peekaboo permissions status`
