# Peekaboo Dock Right Click

## Purpose
Right-click a Dock item through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.dock.right_click`
- Wrapper operation: `dock.right_click`
- Peekaboo CLI mapping: `peekaboo dock right-click`
