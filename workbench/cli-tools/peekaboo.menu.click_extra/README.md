# Peekaboo Menu Extra Click

## Purpose
Click a menu extra through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.menu.click_extra`
- Wrapper operation: `menu.click_extra`
- Peekaboo CLI mapping: `peekaboo menu click-extra`
