# Peekaboo Dialog Click

## Purpose
Click a system dialog control through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.dialog.click`
- Wrapper operation: `dialog.click`
- Peekaboo CLI mapping: `peekaboo dialog click`
