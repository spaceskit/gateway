# Harvest Clients Time Report

## Purpose
Return the Harvest clients time report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.time.clients`
- Wrapper operation: `reports.time.clients`
- Harvest CLI mapping: `hrvst reports time-reports clients-time-report`
