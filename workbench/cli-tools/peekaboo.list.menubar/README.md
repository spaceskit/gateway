# Peekaboo List Menu Bar

## Purpose
List menu bar extras visible to Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.list.menubar`
- Wrapper operation: `list.menubar`
- Peekaboo CLI mapping: `peekaboo list menubar`
