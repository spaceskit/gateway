...
## Purpose
List all menus for an application through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.menu.list_all`
- Wrapper operation: `menu.list_all`
- Peekaboo CLI mapping: `peekaboo menu list-all`
