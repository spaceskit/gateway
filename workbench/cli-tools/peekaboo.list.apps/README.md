...
## Purpose
List running or known macOS applications visible to Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.list.apps`
- Wrapper operation: `list.apps`
- Peekaboo CLI mapping: `peekaboo list apps`
