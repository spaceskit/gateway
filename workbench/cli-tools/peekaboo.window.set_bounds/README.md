...
## Purpose
Set target window bounds through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.window.set_bounds`
- Wrapper operation: `window.set_bounds`
- Peekaboo CLI mapping: `peekaboo window set-bounds`
