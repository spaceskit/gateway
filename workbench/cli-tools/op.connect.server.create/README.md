# 1Password Connect Server Create

## Purpose
Create a 1Password Connect server and credentials file.

## Wrapper Operation
- Tool id: `op.connect.server.create`
- Wrapper operation: `connect.server.create`
- 1Password CLI mapping: `op connect server create`
