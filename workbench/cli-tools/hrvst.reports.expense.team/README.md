# Harvest Team Expense Report

## Purpose
Return the Harvest team expense report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.expense.team`
- Wrapper operation: `reports.expense.team`
- Harvest CLI mapping: `hrvst reports expense-reports team-expense-report`
