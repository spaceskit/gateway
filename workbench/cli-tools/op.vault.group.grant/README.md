# 1Password Vault Group Grant

## Purpose
Grant a group access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.vault.group.grant`
- Wrapper operation: `vault.group.grant`
- 1Password CLI mapping: `op vault group grant <vault> <group>`
