...
## Purpose
List macOS permission state for Peekaboo automation surfaces.

## Wrapper Operation
- Tool id: `peekaboo.list.permissions`
- Wrapper operation: `list.permissions`
- Peekaboo CLI mapping: `peekaboo list permissions`
