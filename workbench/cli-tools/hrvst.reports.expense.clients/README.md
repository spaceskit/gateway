# Harvest Clients Expense Report

## Purpose
Return the Harvest clients expense report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.expense.clients`
- Wrapper operation: `reports.expense.clients`
- Harvest CLI mapping: `hrvst reports expense-reports clients-expense-report`
