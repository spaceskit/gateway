...
## Purpose
Set clipboard content, paste it, and restore clipboard state through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.paste`
- Wrapper operation: `paste`
- Peekaboo CLI mapping: `peekaboo paste`
