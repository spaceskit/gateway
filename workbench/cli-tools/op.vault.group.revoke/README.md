# 1Password Vault Group Revoke

## Purpose
Revoke a group's access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.vault.group.revoke`
- Wrapper operation: `vault.group.revoke`
- 1Password CLI mapping: `op vault group revoke <vault> <group>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: vault, group.
