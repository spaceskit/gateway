# 1Password Connect Vault Grant

## Purpose
Grant a Connect server access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.connect.vault.grant`
- Wrapper operation: `connect.vault.grant`
- 1Password CLI mapping: `op connect vault grant <server> <vault>`
