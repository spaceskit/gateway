# Peekaboo Menubar Click

## Purpose
Click a status-bar item through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.menubar.click`
- Wrapper operation: `menubar.click`
- Peekaboo CLI mapping: `peekaboo menubar click`
