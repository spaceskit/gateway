# 1Password Group User Revoke

## Purpose
Remove a user from a 1Password group.

## Wrapper Operation
- Tool id: `op.group.user.revoke`
- Wrapper operation: `group.user.revoke`
- 1Password CLI mapping: `op group user revoke <group> <user>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: group, user.
