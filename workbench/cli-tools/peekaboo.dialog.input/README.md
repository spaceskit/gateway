# Peekaboo Dialog Input

## Purpose
Type into a system dialog through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.dialog.input`
- Wrapper operation: `dialog.input`
- Peekaboo CLI mapping: `peekaboo dialog input`
