...
## Purpose
Minimize a target window through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.window.minimize`
- Wrapper operation: `window.minimize`
- Peekaboo CLI mapping: `peekaboo window minimize`
