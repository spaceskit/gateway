# 1Password Vault User Grant

## Purpose
Grant a user access to a 1Password vault.

## Wrapper Operation
- Tool id: `op.vault.user.grant`
- Wrapper operation: `vault.user.grant`
- 1Password CLI mapping: `op vault user grant <vault> <user>`
