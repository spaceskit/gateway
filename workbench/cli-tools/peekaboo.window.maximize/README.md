...
## Purpose
Maximize a target window through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.window.maximize`
- Wrapper operation: `window.maximize`
- Peekaboo CLI mapping: `peekaboo window maximize`
