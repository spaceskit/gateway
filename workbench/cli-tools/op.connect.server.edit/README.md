# 1Password Connect Server Edit

## Purpose
Rename a 1Password Connect server.

## Wrapper Operation
- Tool id: `op.connect.server.edit`
- Wrapper operation: `connect.server.edit`
- 1Password CLI mapping: `op connect server edit <server>`
