...
## Purpose
List macOS windows available for Peekaboo capture and automation.

## Wrapper Operation
- Tool id: `peekaboo.list.windows`
- Wrapper operation: `list.windows`
- Peekaboo CLI mapping: `peekaboo list windows`
