# Peekaboo Window Move

## Purpose
Move a target window through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.window.move`
- Wrapper operation: `window.move`
- Peekaboo CLI mapping: `peekaboo window move`
