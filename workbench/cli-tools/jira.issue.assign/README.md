...
## Purpose
Assign a Jira issue and return the refreshed issue payload.

## Wrapper Operation
- Tool id: `jira.issue.assign`
- Wrapper operation: `issue.assign`
- Jira CLI mapping: `jira issue assign ISSUE-KEY ASSIGNEE`
...
- `assignee` (required): Assignee email or exact display name.
