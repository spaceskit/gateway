# 1Password User Delete

## Purpose
Delete a 1Password user and all their data.

## Wrapper Operation
- Tool id: `op.user.delete`
- Wrapper operation: `user.delete`
- 1Password CLI mapping: `op user delete <user>`
