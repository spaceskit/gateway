# 1Password User Reactivate

## Purpose
Reactivate a suspended 1Password user.

## Wrapper Operation
- Tool id: `op.user.reactivate`
- Wrapper operation: `user.reactivate`
- 1Password CLI mapping: `op user reactivate <user>`
