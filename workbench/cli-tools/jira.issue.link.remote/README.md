# Jira Remote Link Add

## Purpose
Attach a remote web link to a Jira issue and return the refreshed issue payload.

## Wrapper Operation
- Tool id: `jira.issue.link.remote`
- Wrapper operation: `issue.link.remote`
- Jira CLI mapping: `jira issue link remote ISSUE-KEY URL TITLE`
...
- `url` (required): Remote link URL.
- `title` (required): Remote link title.
