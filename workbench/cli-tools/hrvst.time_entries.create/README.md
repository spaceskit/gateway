...
## Purpose
Create a Harvest time entry using either duration fields or start/end timestamp fields.

## Wrapper Operation
- Tool id: `hrvst.time_entries.create`
- Wrapper operation: `time_entries.create`
- Harvest CLI mapping: `hrvst time-entries create`
