# Harvest Expense Categories Report

## Purpose
Return the Harvest expense categories report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.expense.categories`
- Wrapper operation: `reports.expense.categories`
- Harvest CLI mapping: `hrvst reports expense-reports categories-report`
