# Harvest Team Time Report

## Purpose
Return the Harvest team time report for a time window.

## Wrapper Operation
- Tool id: `hrvst.reports.time.team`
- Wrapper operation: `reports.time.team`
- Harvest CLI mapping: `hrvst reports time-reports team-time-report`
