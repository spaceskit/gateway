# 1Password Connect Server Delete

## Purpose
Delete a 1Password Connect server.

## Wrapper Operation
- Tool id: `op.connect.server.delete`
- Wrapper operation: `connect.server.delete`
- 1Password CLI mapping: `op connect server delete <server>`
...
## Payload
- `arguments` (required): Ordered positional arguments after the subcommand: server.
