# Harvest Time Entry Update

## Purpose
Update a Harvest time entry.

## Wrapper Operation
- Tool id: `hrvst.time_entries.update`
- Wrapper operation: `time_entries.update`
- Harvest CLI mapping: `hrvst time-entries update`
