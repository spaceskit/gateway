# Peekaboo Move Pointer

## Purpose
Move the cursor to coordinates, element centers, or screen center through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.move`
- Wrapper operation: `move`
- Peekaboo CLI mapping: `peekaboo move`
