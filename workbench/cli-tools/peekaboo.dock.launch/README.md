# Peekaboo Dock Launch

## Purpose
Launch a Dock item through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.dock.launch`
- Wrapper operation: `dock.launch`
- Peekaboo CLI mapping: `peekaboo dock launch`
