...
## Purpose
Append or overwrite notes on the current Harvest timer.

## Wrapper Operation
- Tool id: `hrvst.time_tracking.note`
- Wrapper operation: `time_tracking.note`
- Harvest CLI mapping: `hrvst note`
