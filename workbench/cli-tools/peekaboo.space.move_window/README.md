# Peekaboo Space Move Window

## Purpose
Move a window between macOS Spaces through Peekaboo.

## Wrapper Operation
- Tool id: `peekaboo.space.move_window`
- Wrapper operation: `space.move_window`
- Peekaboo CLI mapping: `peekaboo space move-window`
