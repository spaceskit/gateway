# 1Password Document Delete

## Purpose
Delete a 1Password document.

## Wrapper Operation
- Tool id: `op.document.delete`
- Wrapper operation: `document.delete`
- 1Password CLI mapping: `op document delete <document>`
